export const apis = {
  ...
  user: {
    ...
    getEventInterestedByIdUser: ({idUser}: {idUser: string}) =>
      `/get-event-interested-byIdUser?idUser=${idUser}`,
  ...
  notification: {
    ...
    getNotificationsById: ({
      ...
      if (statusFillter !== undefined)
        params.append('statusFillter', statusFillter);
  ...
  event: {
    ...
    getDescriptionEvent: ({idEvent}: {idEvent: string}) =>
      `/get-description-byIdEvent?idEvent=${idEvent}`,
    getShowTimesEvent: ({idEvent}: {idEvent: string}) =>
      `/get-showTimes-byIdEvent?idEvent=${idEvent}`,
  },
  category: {
  ...
  invoice: {
    ...
    getByIdUser: ({
      ...
      idUser?: string;
      searchValue?: string;
      filterMonthTime?: string;
      filterYearTime?: string;
    }) => {
      const params = new URLSearchParams();
      if (idUser !== undefined) params.append('idUser', idUser);
      if (searchValue !== undefined) params.append('searchValue', searchValue);
      if (filterMonthTime !== undefined)
        params.append('filterMonthTime', filterMonthTime);
      if (filterYearTime !== undefined)
        params.append('filterYearTime', filterYearTime);
  ...
  ticket: {
    ...
    getByIdUser: ({
      ...
      uid?: string;
      typeFilter?: 'UpComing' | 'Ended' | 'Canceled';
    }) => {
      const params = new URLSearchParams();
  ...
  comment: {
    ...
    getByIdEvent: ({
      ...
      `/get-byIdEvent?idEvent=${idEvent}&idUser=${idUser}&idAuthor=${idAuthor}`,
