...
const AvatarGroup = (props: Props) => {
  ...
  return (
    <RowComponent styles={{ marginVertical: 10 }}>
      ...
      <TextComponent text="+20 người đã tham gia" size={12  + (size ? (size-24)/12 : 0)} color={colors.primary} font={fontFamilies.semiBold} />
      {
        isShowButton && (
          <>
            ...
            <TouchableOpacity style={{
              ...
              <TextComponent size={12} color={colors.white} text="Mời thêm" />
            </TouchableOpacity>
          </>
        )
      }
