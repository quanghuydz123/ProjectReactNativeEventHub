    ...
    <ContainerComponent back isImageBackgound isScroll>
      <SectionComponent>
        ...
        <RowComponent justify="space-around">
            <TextInput value={codeValues[0]} keyboardType="number-pad" style={[style.input]} maxLength={1} onChangeText={(val) => {handleOnchangeCode(val,0), val ? ref2.current.focus() : ref1.current.focus()}} placeholder="-" ref={ref1}/>
            <TextInput value={codeValues[1]} keyboardType="number-pad" style={[style.input]} maxLength={1} onChangeText={(val) => {handleOnchangeCode(val,1), val ? ref3.current.focus() : ref1.current.focus()}} placeholder="-" ref={ref2}/>
            <TextInput value={codeValues[2]} keyboardType="number-pad" style={[style.input]} maxLength={1} onChangeText={(val) => {handleOnchangeCode(val,2), val ? ref4.current.focus() : ref2.current.focus()}} placeholder="-" ref={ref3}/>
            <TextInput value={codeValues[3]} keyboardType="number-pad" style={[style.input]} maxLength={1} onChangeText={(val) => {handleOnchangeCode(val,3), !val && ref3.current.focus()}} placeholder="-" ref={ref4}/>
        </RowComponent>
      </SectionComponent>
