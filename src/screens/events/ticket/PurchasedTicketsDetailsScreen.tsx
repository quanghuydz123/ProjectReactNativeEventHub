...
const PurchasedTicketsDetailsScreen = ({navigation, route}: any) => {
  ...
  useEffect(() => {
    if (
      invoice &&
      invoice?.ticketsPurchase &&
      invoice?.ticketsPurchase?.length > 0
    ) {
      const groupedByTypeTicket = invoice?.ticketsPurchase?.reduce(
        (acc: any, ticket) => {
    ...
    return (
      <CardComponent
        ...
        }}>
        {
          <>
            <TextComponent
              text={invoice.eventDetails.title}
              color={colors.white}
            ...
            <TouchableOpacity
              onPress={() =>
                navigation.navigate('EventDetails', {
                  id: invoice.eventDetails._id,
                })
              }>
              <Image
                source={{uri: invoice.eventDetails.photoUrl}}
                style={{
                ...
                <View>
                  <RowComponent>
                    ...
                    <TagComponent
                      ...
                      bgColor={
                        ticket.isCheckIn ? colors.primary : colors.warning
                      }
                    />
                  </RowComponent>
                  ...
                  <RowComponent>
                    <TextComponent
                      text={`${ticket.typeTicketDetails.name}`}
                      color={colors.primary}
                      size={15}
                      font={fontFamilies.medium}
                    />
                    <SpaceComponent width={8} />
                    {ticket.typeTicketDetails.status === 'Canceled' && (
                      <TagComponent
                        label={'Đã bị hủy'}
                        styles={{
                          paddingVertical: 2,
                ...
                <View>
                  ...
                  <TextComponent
                    text={`${DateTime.GetTime(
                      invoice.showTimeDetails.startDate,
                    )} - ${DateTime.GetTime(invoice.showTimeDetails.endDate)}`}
                    size={18}
                    font={fontFamilies.medium}
                    color={colors.primary}
                  />
                  <TextComponent
                    text={`${DateTime.GetDateNew1(
                      invoice.showTimeDetails.startDate,
                      invoice.showTimeDetails.endDate,
                    )}`}
                    size={18}
                    font={fontFamilies.medium}
                    color={colors.primary}
            ...
            {invoice &&
              invoice.ticketsPurchase &&
              invoice.ticketsPurchase.length > 1 && (
                <TextComponent
                  text={'Vuốt ngang màn hình để xem'}
                  textAlign="center"
                  color={colors.white}
                  size={11}
                  styles={{paddingTop: 22}}
                />
              )}
            ...
            <CricleComponent
              ...
              color={colors.black}
              size={24}
              styles={{position: 'absolute', bottom: -16, left: -12}}
            />
            <CricleComponent
              children={<></>}
              color={colors.black}
              size={24}
              styles={{position: 'absolute', bottom: -16, right: -12}}
            />
          </>
        }
      </CardComponent>
  ...
  const renderTypeTicket = (ticket: TicketsPurchase, length: number) => {
    ...
    const renderPrice = () => {
      if (ticket?.promotion) {
        if (ticket.discountType === 'Percentage') {
          return convertMoney(
            ((ticket.price * (100 - ticket.discountValue)) / 100) * length,
          );
        } else {
    ...
    return (
      <RowComponent
        ...
        <View
          ...
          <RowComponent>
            <TextComponent
              text={convertMoney(ticket?.price)}
              font={fontFamilies.medium}
              textAlign="left"
              size={12}
              color={colors.white}
        ...
        <View
          ...
          <TextComponent
            text={convertMoney(renderPriceDiscount())}
            textAlign="right"
            size={12}
            color={colors.white}
          />
    ...
    <>
      <ContainerComponent
        ...
        <SectionComponent>
          ...
          <CardComponent
            color={colors.background3}
            styles={{minHeight: appInfo.sizes.HEIGHT * 0.5}}>
            {isLoading ? (
              <View
                style={{
                  height: appInfo.sizes.HEIGHT * 0.5,
              ...
              <>
                <RowComponent>
                  ...
                  <TextComponent
                    text={`Đơn hàng: ${invoice?.invoiceDetails?.invoiceCode}`}
                    color={colors.white}
                    font={fontFamilies.semiBold}
                    size={13}
                  />
                ...
                <View style={{borderWidth: 1, borderColor: colors.black}}>
                  ...
                  <RowComponent
                    justify="space-between"
                    styles={{backgroundColor: colors.background1}}>
                    <View
                      style={{
                        paddingLeft: 10,
                        paddingRight: 22,
                      ...
                      <RowComponent>
                        ...
                        <SpaceComponent width={4} />
                        <TextComponent
                          text={DateTime.GetDate2(
                            invoice?.invoiceDetails?.createdAt ?? new Date(),
                          )}
                          flex={1}
                          textAlign="left"
                          size={12}
                    ...
                    <TextComponent
                      text={invoice?.invoiceDetails?.paymentMethod ?? ''}
                      styles={{
                        padding: 16,
                        borderLeftWidth: 1,
                        borderRightWidth: 1,
                ...
                <View style={{borderWidth: 1, borderColor: colors.black}}>
                  <RowComponent
                    styles={{borderBottomWidth: 1, borderColor: colors.black}}>
                    <TextComponent
                      text={'Tên'}
                      font={fontFamilies.medium}
                      styles={{
                        minWidth: appInfo.sizes.WIDTH * 0.3,
                        padding: 8,
                        backgroundColor: colors.background2,
                      }}
                      color={colors.white}
                    ...
                    />
                    <TextComponent
                      text={invoice?.invoiceDetails?.fullname ?? ''}
                      styles={{
                        flex: 1,
                        padding: 8,
                        backgroundColor: colors.background1,
                  ...
                  <RowComponent
                    ...
                    />
                    <TextComponent
                      text={invoice?.invoiceDetails?.email ?? ''}
                      styles={{
                        flex: 1,
                        padding: 8,
                        backgroundColor: colors.background1,
                  ...
                  <RowComponent
                    ...
                    />
                    <TextComponent
                      text={invoice?.invoiceDetails?.phoneNumber ?? ''}
                      styles={{
                        flex: 1,
                        padding: 8,
                        backgroundColor: colors.background1,
                  ...
                  <RowComponent styles={{backgroundColor: colors.background2}}>
                    <TextComponent
                      text={'Địa chỉ'}
                      font={fontFamilies.medium}
                      styles={{minWidth: appInfo.sizes.WIDTH * 0.3, padding: 8}}
                      color={colors.white}
                      size={12}
                    />
                    <TextComponent
                      text={invoice?.invoiceDetails?.fullAddress ?? ''}
                      styles={{
                        flex: 1,
                        padding: 8,
                        backgroundColor: colors.background1,
                ...
                <SpaceComponent height={16} />
                <View
                  style={{borderWidth: 1, borderColor: colors.gray4, flex: 1}}>
                  <RowComponent
                    justify="space-between"
                    styles={{
                      borderBottomWidth: 1,
                  ...
                  <RowComponent
                    ...
                    <View
                      ...
                      <TextComponent
                        text={convertMoney(
                          invoice?.invoiceDetails?.totalDiscountByCoin ?? 0,
                        )}
                        styles={{
                          padding: 8,
                          backgroundColor: colors.background1,
                  ...
                  <RowComponent
                    ...
                    <View
                      ...
                      <TextComponent
                        text={convertMoney(
                          invoice?.invoiceDetails?.totalDiscount ?? 0,
                        )}
                        styles={{
                          padding: 8,
                          backgroundColor: colors.background1,
                  ...
                  <RowComponent
                    styles={{backgroundColor: colors.background1, flex: 1}}>
                    <View style={{flex: 6.1}}>
                      <TextComponent
                        text={'Tổng tiền'}
                        font={fontFamilies.medium}
                    ...
                    <View
                      ...
                      <TextComponent
                        text={convertMoney(
                          invoice?.invoiceDetails?.totalPrice ?? 0,
                        )}
                        styles={{
                          padding: 8,
                          backgroundColor: colors.background1,
            ...
            <CricleComponent
              ...
              color={colors.black}
              size={24}
              styles={{position: 'absolute', top: -16, left: -12}}
            />
            <CricleComponent
              children={<></>}
              color={colors.black}
